...
namespace ScottEwing{
    ...
    public class RayCastHelper{
        ...
        public bool CanSourceSeeTarget<T, TV>(T targetPosition, TV targetId, out RaycastHit hit, Transform nSource = null, CastType? nCastType = null, float? nRadius = null,
            float? nMaxDistance = null,
        ...
        /// <returns></returns>
        public bool Raycast(out RaycastHit hit, Transform nSource = null, Vector3? nDirection = null, float? nMaxDistance = null, LayerMask? nMask = null,
            QueryTriggerInteraction? nTriggerInteraction = null) {
        ...
        public bool SphereCast(out RaycastHit hit, Transform nSource = null, float? nRadius = null, Vector3? nDirection = null, float? nMaxDistance = null, LayerMask? nMask = null,
            QueryTriggerInteraction? nTriggerInteraction = null) {
        ...
        /// </summary>
        /// <returns></returns>
        public bool RaycastForTargets(out RaycastHit hit, Transform nSource = null, Vector3? nDirection = null, float? nMaxDistance = null, LayerMask? nMask = null, LayerMask? nTargetMask = null,
            QueryTriggerInteraction? nTriggerInteraction = null) {
        ...
        /// <summary>
        /// If a target layer mask has been specified then raycast for target using collision layer mask
        /// as obstacles otherwise just raycast for the collision layer mask  
        /// </summary>
        public bool ConditionalSpecifyTargetsCast(out RaycastHit hit) => _specifyTargetLayers ? RaycastForTargets(out hit) : Cast(out hit);
